...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, String> consumerFactory(@Value("$" +
            "{spring.kafka" +
            ".consumer.bootstrap-servers}") final String bootstrapServers) {
    ...
    @Bean
    public ProducerFactory<String, String> producerFactory(@Value("$" +
            "{spring.kafka" +
            ".producer.bootstrap-servers}") final String bootstrapServers) {
        final Map<String, Object> config = new HashMap<>();
