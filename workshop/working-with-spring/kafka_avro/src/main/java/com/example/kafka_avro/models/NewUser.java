 ...
 */
package com.example.kafka_avro.models;
...
public class NewUser extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2603856376946602024L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewUser\",\"namespace\":\"com.example.kafka_avro.models\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}],\"version\":1}");
   ...
   */
  public NewUser(java.lang.Integer id, java.lang.CharSequence name, java.lang.Integer age) {
    this.id = id;
    this.name = name;
    this.age = age;
  }
   ...
   */
  public static com.example.kafka_avro.models.NewUser.Builder newBuilder() {
    return new com.example.kafka_avro.models.NewUser.Builder();
  }
   ...
   * @return A new NewUser RecordBuilder
   */
  public static com.example.kafka_avro.models.NewUser.Builder newBuilder(com.example.kafka_avro.models.NewUser.Builder other) {
    return new com.example.kafka_avro.models.NewUser.Builder(other);
  }
   ...
   * @return A new NewUser RecordBuilder
   */
  public static com.example.kafka_avro.models.NewUser.Builder newBuilder(com.example.kafka_avro.models.NewUser other) {
    return new com.example.kafka_avro.models.NewUser.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewUser>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka_avro.models.NewUser.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka_avro.models.NewUser other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_avro.models.NewUser.Builder clearAge() {
